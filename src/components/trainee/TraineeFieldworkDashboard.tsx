...
export default function TraineeFieldworkDashboard({
  ...
  return (
    ...
    `}</style>
      ...
      .top-nav{height:68px;display:flex;align-items:center;justify-content:space-between}.brand-logo{display:block;width:auto;height:34px;object-fit:contain}.role-pill{font-size:11px;color:#53657d;background:#fff;border:1px solid #dfe6f0;padding:6px 11px;border-radius:99px}
    ...
    `}</style>
      ...
      <style>{`.trainee-tabs button{min-height:42px;justify-content:center;line-height:1}.trainee-tabs .tab-icon{display:block}`}</style>
